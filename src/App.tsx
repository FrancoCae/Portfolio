      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1600px] flex-col">
        ...
        <div className="grid flex-1 items-center gap-8 py-20 lg:grid-cols-[1.25fr_0.75fr] xl:grid-cols-[1.15fr_0.85fr] 2xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <motion.div
            ...
            className="relative mx-auto hidden aspect-square w-full max-w-[12rem] lg:block lg:max-w-[14rem] xl:max-w-[22rem] 2xl:max-w-[34rem]"
          >
            ...
            <motion.div
              ...
              className="absolute left-3 top-3 scale-[0.42] lg:scale-[0.5] xl:scale-[0.8] 2xl:scale-100 rounded-2xl border border-white/10 bg-white/[0.04] p-2 xl:p-5 text-mist backdrop-blur origin-top-left"
            >
...
Python · SQL · ML
            ...
            <motion.div
              ...
              className="absolute bottom-3 right-3 w-32 xl:w-64 scale-[0.42] lg:scale-[0.5] xl:scale-[0.8] 2xl:scale-100 rounded-2xl border border-white/10 bg-mist p-2 xl:p-5 text-night shadow-2xl origin-bottom-right">
