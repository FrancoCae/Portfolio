        ...
        <div className="grid flex-1 items-center gap-8 py-20 lg:grid-cols-[1.25fr_0.75fr] xl:grid-cols-[1.15fr_0.85fr] 2xl:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute left-3 top-3 w-48 scale-[0.21] lg:scale-[0.27] xl:scale-[0.66] 2xl:scale-100 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 xl:p-5 text-mist backdrop-blur origin-top-left"
            >
...
Python · SQL · ML
            ...
            <motion.div
              ...
              className="absolute bottom-3 right-3 w-56 scale-[0.21] lg:scale-[0.27] xl:scale-[0.66] 2xl:scale-100 rounded-2xl border border-white/10 bg-mist px-4 py-3 xl:p-5 text-night shadow-2xl origin-bottom-right"
              >
